...
LOG_DIR = os.path.join(BASE_DIR, "viewsfer/private/log")

EXE_DIR = os.path.join(BASE_DIR, "viewsfer/private/exe")
...
MIDDLEWARE = [
    ...
    "viewsfer.middleware.AuditMiddleware",
...
WSGI_APPLICATION = "viewsfer.wsgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "viewsfer/static/")]
